...
" -e always extract features (i.e., don't skip features that are the same for all instances, and don't skip length-1 1-best lists),\n"
...
int main(int argc, char **argv) {
  ...
  int c;
  while ((c = getopt(argc, argv, "acd:ef:ils:")) != -1 )
    switch (c) {
    case 'a':
