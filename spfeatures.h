...
extern bool force_extract;   //!< don't skip features
...
public:
  ...
  static void extract_features_helper(FeatClass& fc, const sp_sentence_type& s) {
    ...
    if (!force_extract && s.nparses() <= 1)   // ignore unambiguous sentences
      return;
...
public:
  ...
  inline void features_050902(bool nonlocal=true);
...
////////////////////////////////////////////////////////////////////////
//                                                                    //
//                      Feature Classes used in reranker              //
//                                                                    //
////////////////////////////////////////////////////////////////////////
...
inline void FeatureClassPtrs::features_dp_27Aug05() {
  ...
  push_back(new WordNeighbours(false, 0,0));
  push_back(new WordNeighbours(false, 0,1));
  push_back(new WordNeighbours(false, 0,2));
  push_back(new WordNeighbours(false, 1,0));
  push_back(new WordNeighbours(false, 2,0));
  push_back(new WordNeighbours(false, 1,1));
  push_back(new WordNeighbours(false, 1,2));
  push_back(new WordNeighbours(false, 2,1));
  push_back(new WordNeighbours(false, 2,2));

  push_back(new WordNeighbours(true, 0,0));
  push_back(new WordNeighbours(true, 0,1));
  push_back(new WordNeighbours(true, 0,2));
  push_back(new WordNeighbours(true, 1,0));
  push_back(new WordNeighbours(true, 2,0));
  push_back(new WordNeighbours(true, 1,1));
  push_back(new WordNeighbours(true, 1,2));
  push_back(new WordNeighbours(true, 2,1));
  push_back(new WordNeighbours(true, 2,2));

}  // FeatureClassPtrs::features_dp_27Aug05()

inline void FeatureClassPtrs::features_dp_31Aug05() {
  push_back(new NLogP());

  size_type maxwidth = 1;
...
}  // FeatureClassPtrs::features_dp_31Aug05()
*/


/*
inline void FeatureClassPtrs::edgefeatures_071202() {
  push_back(new NLogP());
  push_back(new RightBranch());
  ...
  for (size_type binflag = 0; binflag < 2; ++binflag)
	...
	for (size_type nrightprec = 0; nrightprec <= maxwidth; ++nrightprec)
	  for (size_type nrightsucc = 0; nrightsucc <= maxwidth; ++nrightsucc)
	    if (nleftprec + nleftsucc + nrightprec + nrightsucc <= maxsumwidth)
	      push_back(new WordEdges(binflag, nleftprec, nleftsucc, nrightprec, nrightsucc));
}  // FeatureClassPtrs::edgefeatures_071202()


inline void FeatureClassPtrs::edgeplusfeatures_080223() {
  push_back(new NLogP());
  push_back(new RightBranch());
  push_back(new Heavy());
  ...
  for (size_type binflag = 0; binflag < 2; ++binflag)
	...
	for (size_type nrightprec = 0; nrightprec <= maxwidth; ++nrightprec)
	  for (size_type nrightsucc = 0; nrightsucc <= maxwidth; ++nrightsucc)
	    if (nleftprec + nleftsucc + nrightprec + nrightsucc <= maxsumwidth)
	      push_back(new WordEdges(binflag, nleftprec, nleftsucc, nrightprec, nrightsucc));
}  // FeatureClassPtrs::edgeplusfeatures_080223()


inline void FeatureClassPtrs::wordedgefeatures_080224() {
  push_back(new NLogP());
  push_back(new RightBranch());
  push_back(new Heavy());
  ...
  for (size_type binflag = 0; binflag < 2; ++binflag)
	...
	for (size_type nrightprec = 0; nrightprec <= maxwidth; ++nrightprec)
	  for (size_type nrightsucc = 0; nrightsucc <= maxwidth; ++nrightsucc)
	    if (nleftprec + nleftsucc + nrightprec + nrightsucc <= maxsumwidth)
	      push_back(new WordEdges(binflag, nleftprec, nleftsucc, nrightprec, nrightsucc));
}  // FeatureClassPtrs::wordedgefeatures_080224()


inline void FeatureClassPtrs::nonedgefeatures_071202() {
  push_back(new NLogP());
  ...
  push_back(new CoLenPar());
}  // FeatureClassPtrs::nonedgefeatures_071202()


inline void FeatureClassPtrs::ecfeatures_071202() {
  push_back(new NLogP());
  ...
  push_back(new Heads(2, true, true, Heads::semantic));
  push_back(new Heads(3, false, false));
}  // FeatureClassPtrs::ecfeatures_071202()


inline void FeatureClassPtrs::nonecfeatures_071202() {
  push_back(new NLogP());
...
}  // FeatureClassPtrs::nonecfeatures_071202()


inline void FeatureClassPtrs::rulefeatures_071207() {
  push_back(new NLogP());
...
}  // FeatureClassPtrs::rulefeatures_071207()


inline void FeatureClassPtrs::nonrulefeatures_071207() {
  push_back(new NLogP());
...
}  // FeatureClassPtrs::nonrulefeatures_071207()
*/


inline void FeatureClassPtrs::features_050902(bool nonlocal) {
...
inline void FeatureClassPtrs::features_spnn(bool nngram) {
  push_back(new NLogP());
...
inline FeatureClassPtrs::FeatureClassPtrs(const char* fcname) {
  ...
  if (fcname == NULL)
    features_050902();
  else if (strcmp(fcname, "local") == 0)
	features_050902(false);
  else if (strcmp(fcname, "sp") == 0)
    features_spnn(false);
